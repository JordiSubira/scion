...
// Source: github.com/scionproto/scion/go/pkg/trust (interfaces: DB,Fetcher,Inspector,KeyRing,Provider,Recurser,Router,X509KeyPairLoader,KeyLoader)
...
func (m *MockX509KeyPairLoader) LoadX509KeyPair(arg0 []x509.ExtKeyUsage) (*tls.Certificate, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "LoadX509KeyPair", arg0)
...
func (mr *MockX509KeyPairLoaderMockRecorder) LoadX509KeyPair(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "LoadX509KeyPair", reflect.TypeOf((*MockX509KeyPairLoader)(nil).LoadX509KeyPair), arg0)
}
...
func (m *MockKeyLoader) GetKeys(arg0 context.Context) ([][]byte, error) {
	m.ctrl.T.Helper()
...
func (mr *MockKeyLoaderMockRecorder) GetKeys(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetKeys", reflect.TypeOf((*MockKeyLoader)(nil).GetKeys), arg0)
}
